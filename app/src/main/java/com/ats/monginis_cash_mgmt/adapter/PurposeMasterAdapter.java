...
public class PurposeMasterAdapter extends BaseAdapter {
    Context context;
    private ArrayList<PurposeList> originalValues;
    private ArrayList<PurposeList> displayedValues;
    LayoutInflater inflater;

    public PurposeMasterAdapter(Context context, ArrayList<PurposeList> catArray) {
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        tvName.setText("" + displayedValues.get(position).getPurpose());
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        if (menuItem.getItemId() == R.id.action_edit) {
                            ...
                            Fragment adf = new PurposeMasterFragment();
                            Bundle args = new Bundle();
                            args.putString("PurposeName", displayedValues.get(position).getPurpose());
                            args.putInt("PurposeId", displayedValues.get(position).getPurposeId());
                            ...
                            builder.setMessage("Do You Really Want To Delete Purpose?");
                            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    deletePurposeById(displayedValues.get(position).getPurposeId());
                                    dialog.dismiss();
                                }
                            });
    ...
    public void deletePurposeById(int pId) {
        ...
        Call<ErrorMessage> errorMessageCall = api.deletePurpose(pId);
                ...
                try {
                    if (response.body() != null) {
                        ...
                        if (message.getError()) {
                            ...
                            Fragment adf = new PurposeMasterFragment();
                            Bundle args = new Bundle();
                            args.putString("PurposeName", "");
                            args.putInt("PurposeId", 0);
                            adf.setArguments(args);
                            activity.getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, adf, "HomeFragment").commit();
