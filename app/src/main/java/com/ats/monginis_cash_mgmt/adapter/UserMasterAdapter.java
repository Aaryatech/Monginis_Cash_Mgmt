...
public class UserMasterAdapter extends BaseAdapter {
    ...
    Context context;
    private ArrayList<UserList> originalValues;
    private ArrayList<UserList> displayedValues;
    LayoutInflater inflater;

    public UserMasterAdapter(Context context, ArrayList<UserList> catArray) {
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        tvMobile.setText("" + displayedValues.get(position).getUserMobile());
        tvEmail.setText("" + displayedValues.get(position).getUserEmailId());
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        if (menuItem.getItemId() == R.id.action_edit) {
                            ...
                            args.putString("UserMobile", displayedValues.get(position).getUserMobile());
                            args.putString("UserEmail", displayedValues.get(position).getUserEmailId());
                            args.putFloat("UserLimit", displayedValues.get(position).getMaxLimit());
                            args.putInt("IsActive", displayedValues.get(position).getIsActive());
                            args.putInt("UserType", displayedValues.get(position).getUserType());
                            adf.setArguments(args);
                            activity.getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, adf, "UserMaster").commit();
    ...
    public void deleteUserById(int userId) {
        ...
        Call<ErrorMessage> errorMessageCall = api.deleteUser(userId);
                ...
                try {
                    if (response.body() != null) {
                        ...
                        if (message.getError()) {
                            ...
                            HomeActivity activity = (HomeActivity) context;
                            Fragment adf = new UserManagementFragment();
                            Bundle args = new Bundle();
                            adf.setArguments(args);
